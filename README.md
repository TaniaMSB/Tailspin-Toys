...
The repository's commenting, documentation, component contract, and TypeScript
formatting conventions are documented in
[`coding-standards.instructions.md`](.github/instructions/coding-standards.instructions.md).
In particular, comments should explain intent rather than restate mechanics,
exported data-layer functions require TSDoc/JSDoc, and reusable Astro
components must document their `Props` interfaces. Run `npm run lint` after
